...
const foundation: Question[] = [
    {
        ...
        question: "지문에 따르면, Agentic AI와 전통적인 AI의 주요 차이점은 무엇인가?",
        choices: [
            "Agentic AI는 구축 비용이 더 저렴하다.",
            "Agentic AI는 독립적으로 행동할 수 있다.",
            "Agentic AI는 더 많은 인간의 명령을 필요로 한다.",
            "Agentic AI는 여행 계획에만 사용된다."
        ],
        answer: 1,
        explanation: "지문에서는 전통적인 AI가 명령을 기다리는 반면, Agentic AI는 '스스로 생각하고, 계획하고, 행동할 수 있으며(can think, plan, and act on its own)' 독립적으로 결정을 내린다고 명시하고 있습니다."
    },
    {
        id: "d-20260206-f-2",
        level: "Foundation",
        ...
        question: "지문에서 언급된 '서비스로서의 제품(Product-as-a-Service)' 모델의 주요 이점은 무엇인가?",
        choices: [
            "고객이 더 많은 제품을 소유할 수 있다.",
            "제품이 더 빨리 버려진다.",
            "제품이 수리되어 더 오래 사용된다.",
            "전구를 구입하는 것이 더 저렴하다."
        ],
        answer: 2,
        explanation: "지문에서는 '제품이 고장 나면 회사가 수리하거나 교체해주며... 제품이 더 오랫동안 사용된다(products are used for a longer time)'고 말합니다."
    },
    {
        id: "d-20260206-f-3",
        level: "Foundation",
        ...
        question: "지문에 따르면, 기록적인 태양광 및 풍력 도입에도 불구하고 2026년 재생 에너지로의 전환을 복잡하게 만드는 구체적인 요인은 무엇인가?",
        choices: [
            "태양광 패널 수입에 대한 전 세계적인 금지",
            "AI와 데이터 센터에 의한 전력 수요의 급격한 증가",
            "글로벌 풍력 에너지 시장의 완전한 붕괴",
            "중국 내 전기차 생산 중단"
        ],
        answer: 1,
        explanation: "지문은 화석 연료 수요의 부활을 'AI와 데이터 센터의 폭발적인 전력 소비(explosive power consumption of AI and data centers)'와 명시적으로 연결하고 있습니다."
    },
    {
        id: "d-20260206-f-4",
        level: "Foundation",
        ...
        question: "지문에서 데이터 센터와 관련하여 강조된 자원 문제는 무엇인가?",
        choices: [
            "냉각 시스템을 위한 물 소비 증가",
            "이를 건설할 숙련된 근로자의 부족",
            "새로운 서버를 구축할 물리적 공간의 부족",
            "지역 사회에 영향을 미치는 과도한 소음 공해"
        ],
        answer: 0,
        explanation: "텍스트는 주요 문제로 '냉각을 위한 물 사용(water use for cooling)... 물이 부족한 지역에 스트레스를 준다'고 명시하고 있습니다."
    },
    {
        id: "d-20260206-f-5",
        level: "Foundation",
        ...
        question: "지문에 따르면 2026년 핵융합 에너지의 주요 현황은 무엇인가?",
        choices: [
            "불가능한 것으로 판명되어 자금 지원이 중단되었다.",
            "즉시 모든 핵분열 발전소를 완전히 대체하고 있다.",
            "이론적 개념에서 전략적 투자 현실로 전환되고 있다.",
            "현재 전 세계 전력의 50%를 생산하고 있다."
        ],
        answer: 2,
        explanation: "텍스트는 '핵융합 에너지가 공상 과학 소설의 약속에서 전략적 현실로 이동하고 있다(shifting from a science fiction promise to a strategic reality)'고 언급합니다."
    }
];
...
const intermediate: Question[] = [
    {
        ...
        question: "이러한 추세를 바탕으로, 무엇이 Agentic AI를 이전 세대의 인공지능과 구별하는가?",
        choices: [
            "모든 작업에 대해 수동 데이터 입력에만 의존한다.",
            "정보 검색을 위한 수동적인 데이터베이스 역할만 한다.",
            "복잡한 목표를 달성하기 위해 자율적으로 계획하고 행동할 수 있다.",
            "주로 인터넷 대역폭 사용을 줄이기 위해 설계되었다."
        ],
        answer: 2,
        explanation: "Agentic AI는 '자율적으로 추론하고, 계획하고, 복잡한 워크플로를 실행(autonomously reason, plan, and execute complex workflows)'하는 능력으로 정의됩니다."
    },
    {
        id: "d-20260206-i-2",
        level: "Intermediate",
        ...
        question: "이 규정의 부차적인 경제적 효과는 무엇인가?",
        choices: [
            "탄소 비용을 낮추기 위해 순환 자재 전략 채택을 장려한다.",
            "모든 화석 연료 기반 제품의 수입을 완전히 금지한다.",
            "EU 내에서 디지털 제품 여권의 필요성을 없앤다.",
            "모든 제조 시설을 개발도상국으로 엄격히 이전한다."
        ],
        answer: 0,
        explanation: "CBAM은 기업들이 내재된 배출량을 낮추도록 장려하여, 탄소 비용을 줄이기 위한 '순환 자재 전략(circular material strategies)'을 유도합니다."
    },
    {
        id: "d-20260206-i-3",
        level: "Intermediate",
        ...
        question: "이러한 치료적 변화의 주된 의의는 무엇인가?",
        choices: [
            "의학적 치료보다는 미용적 유전자 강화에 초점을 맞춘다.",
            "이전에 영구적이었던 유전 질환을 근절할 가능성을 열어준다.",
            "모든 전통적인 의약품의 필요성을 대체한다.",
            "투여를 위해 로봇 수술에만 독점적으로 의존한다."
        ],
        answer: 1,
        explanation: "텍스트는 '근본 원인을 해결(address root causes)'하고 잠재적으로 '이전에 영구적이었던 유전 질환을 근절(eradicate previously permanent inherited disorders)'할 수 있는 능력을 강조합니다."
    },
    {
        id: "d-20260206-i-4",
        level: "Intermediate",
        ...
        question: "어떤 요인이 이러한 투자를 가속화하고 있는가?",
        choices: [
            "농업용 물 소비의 전 세계적인 감소.",
            "물 부족 지역의 공급망 위험을 완화해야 할 필요성.",
            "전 세계 모든 수도 사업의 완전한 민영화.",
    ...
    },
    {
        ...
        question: "현대 의학에 이것이 통합됨으로써 얻을 수 있는 핵심적인 이점은 무엇인가?",
        choices: [
            "병원 수익을 늘리기 위해 청구 절차를 자동화한다.",
            "최종 결정을 내리는 인간 의사의 역할을 대체한다.",
            "의료를 사후 대응적 모델에서 사전 예방적 모델로 전환한다.",
            "환자의 개인 정보 보호를 위해 의료 데이터 접근을 제한한다."
        ],
        answer: 2,
        explanation: "'눈에 띄는 증상이 나타나기 전에(before visible symptoms manifest)' 이상 징후를 식별하는 것은 '사전 예방적 모델(proactive, preventative model)'로의 전환을 가능하게 합니다."
    }
];
...
const advanced: Question[] = [
    {
        ...
        choices: [
            "비준수에 대한 징벌적 집행 메커니즘",
            "공급망 전반에 걸친 상호 연결되고 시너지 효과를 내는 특성",
            "자발적인 기업 공개에 대한 독점적 집중",
            "구식 제조 프로토콜에 대한 과도한 의존",
            "비유럽 시장에 대한 제한적 적용 가능성"
        ],
        answer: 1,
        explanation: "텍스트는 정책들이 '유기적으로 기능하도록 설계(engineered to function cohesively)'되었으며 '공유 데이터 아키텍처'를 활용한다고 언급하여, 그들의 '상호 연결되고 시너지 효과를 내는 특성(interconnected and synergistic nature)'을 지적합니다."
    },
    {
        id: "d-20260206-a-2",
        level: "Advanced",
        ...
        question: "'AI가 물리적 세계로 간다(AI goes physical)'는 추세는 전통적인 디지털 AI 응용 분야와 어떻게 다른가?",
        choices: [
            "행정 업무 흐름에서만 인간의 의사 결정을 대체하는 데 초점을 맞춘다.",
            "산업 로봇과 같은 자율 기계로 지능을 확장한다.",
            "글로벌 물류를 위해 위성 기반 네트워크에만 전적으로 의존한다.",
            "창의적인 디자인 작업을 위해 생성형 AI를 우선시한다."
        ],
        answer: 1,
        explanation: "텍스트는 이것이 '지능을 현실 세계로 확장하여 자율 기계에 동력을 제공(extends intelligence into the real world, powering autonomous machines)... 단순한 자동화를 넘어선다'고 명시합니다."
    },
    {
        id: "d-20260206-a-3",
        level: "Advanced",
        ...
        question: "빈칸에 들어갈 말로 가장 적절한 것은?",
        choices: [
            "단기 이익을 극대화하기 위해 환경 공약을 포기하는 것",
            "지정학적 분열을 견딜 수 있는 지속 가능한 전략을 수립하는 것",
            "규제 지침을 위해 국제 조약에만 전적으로 의존하는 것",
            "생산을 중앙 집중화하기 위해 지역 공급망을 제거하는 것",
            "운영 현실보다 이론적 기후 모델을 우선시하는 것"
        ],
        answer: 1,
        explanation: "'파편화(fragmentation)'와 '다지역(multiregional)' 환경을 고려할 때, 기업들은 '지정학적 분열을 견딜 수 있는 지속 가능한 전략(durable strategies that can withstand geopolitical divergence)'을 수립해야 합니다."
    },
    {
        id: "d-20260206-a-4",
        level: "Advanced",
        ...
        question: "핵융합 에너지가 주목받는 동안, 데이터 센터의 즉각적인 급증 수요를 충족할 것으로 예상되는 기술은 무엇인가?",
        choices: [
            "청정 수소 수출 인프라",
            "배터리 저장 장치를 갖춘 유틸리티 규모의 태양광",
            "첨단 핵분열 및 소형 모듈 원자로(SMR)",
            "식물 세포 배양"
        ],
        answer: 2,
        explanation: "지문은 '첨단 핵분열 및 SMR(advanced fission and SMRs)...이 데이터 센터의 폭발적인 수요를 점점 더 많이 감당하게 될 것'이라고 명시하고 있습니다."
    },
    {
        id: "d-20260206-a-5",
        level: "Advanced",
        ...
        question: "기밀 컴퓨팅(Confidential Computing)이 해결하는 구체적인 보안 허점은 무엇인가?",
        choices: [
            "메모리에서 처리되는 동안 데이터를 구체적으로 보호한다.",
            "승인되지 않은 관리자가 데이터를 삭제하는 것을 방지한다.",
            "하드 드라이브에 저장될 때만 데이터를 암호화한다.",
            "사용자를 위해 양자 내성 암호를 자동으로 생성한다."
        ],
        answer: 0,
        explanation: "기밀 컴퓨팅은 '처리 중 안전한 격리 구역 내에 격리(isolating it within a secure enclave during processing)'함으로써 '사용 중인 데이터(data in use)'를 보호합니다."
    },
    {
        id: "d-20260206-prime",
        level: "Advanced",
        ...
        question: "설명된 윤리적 및 규제적 역설을 바탕으로, '접근성 문제'가 해결되지 않을 경우 가장 중대한 시스템적 위험을 나타내는 결과는 무엇인가?",
        choices: [
            "전통적인 제약 제조의 즉각적인 노후화",
            "자본 부족으로 인한 기술 혁신의 정체",
            "생명을 바꾸는 치료법이 부유층에게만 독점되는 의료의 계층화",
            "규제되지 않은 실험을 허용하는 유전자 편집의 전 세계적 민주화"
        ],
        answer: 2,
        explanation: "텍스트는 '사회적 불평등의 심화(exacerbation of societal inequities)'를 경고하며, 이는 치료법이 독점적이 되어 발생하는 '의료의 계층화(stratification of healthcare)' 위험을 암시합니다."
    }
];
...
const mockExamQuestions: Question[] = [
    {
        ...
        question: "화자에 따르면, 2026년 웨어러블 기기의 주요한 새로운 기능은 무엇인가?",
        choices: [
            "모든 의사의 필요성 대체",
            "심장 리듬 추적 및 포도당 수치 모니터링",
            "체내에서 약물 제조",
            "병원 내부에서만 작동"
        ],
        answer: 1,
        explanation: "화자는 2026년의 웨어러블 기기가 '심장 리듬을 추적(track heart rhythms)'하고 '포도당 수치를 모니터링(monitor glucose levels)'할 수 있다고 명시적으로 말합니다."
    },
    {
        id: "d-20260206-m-2",
        level: "Intermediate",
        ...
        question: "지문에 따르면, 2026년 새로운 ESPR 체제하에서 제조업체의 주요 의무는 무엇인가?",
        choices: [
            "제품 설계에 관여하는 모든 직원을 위한 물리적 여권 발급",
            "모든 의류 및 신발 제품에 재활용 소재만 독점적으로 사용",
            "제품 소재 및 수명 주기 영향에 관한 데이터를 디지털로 기록하고 공유",
            "시장 포화를 막기 위해 판매되지 않은 재고 소각"
        ],
        answer: 2,
        explanation: "지문은 디지털 제품 여권(DPPs)이 제조업체로 하여금 '소재 구성 및 수명 주기 영향에 대한 데이터를 캡처하고 공유(capture and share data on material composition and lifecycle impacts)'하도록 요구한다고 명시합니다."
    },
    {
        id: "d-20260206-m-3",
        level: "Advanced",
        ...
        question: "지문에 따르면 'Agentic AI'는 전통적인 AI 도구와 어떻게 다른가?",
        choices: [
            "Agentic AI는 하드웨어 로봇 공학에 국한되며 엔터프라이즈 소프트웨어와 통합될 수 없다.",
            "Agentic AI는 모든 특정 작업에 대해 인간의 입력을 필요로 하는 수동적인 조수 역할을 한다.",
            "Agentic AI는 복잡한 목표를 실행하기 위해 추론하고, 계획하고, 행동하는 자율성을 가지고 있다.",
            "Agentic AI는 워크플로를 향상시키는 것보다 주로 구형 IT 인프라를 대체하도록 설계되었다."
        ],
        answer: 2,
        explanation: "지문은 전통적인 AI와 달리 Agentic AI는 '자율적으로 추론하고, 계획하고, 행동(reason, plan, and act autonomously)'할 수 있다고 대조합니다."
    },
    {
        id: "d-20260206-m-4",
        level: "Advanced",
        ...
        question: "지문을 바탕으로, 2026년의 CRISPR 기술 발전이 초기 개발 단계와 구별되는 점은 무엇인가?",
        choices: [
            "실험실에서 벗어나 살아있는 인간 세포 내의 돌연변이를 적극적으로 교정한다.",
            "전염병을 치료하는 것보다 주로 진단하는 데 사용된다.",
            "인간에 대한 안전성 우려로 인해 농업용으로만 제한되었다.",
            "질병의 유전적 원인을 해결하기보다는 증상 억제에 초점을 맞춘다."
        ],
        answer: 0,
        explanation: "텍스트는 '실험실의 호기심 거리(laboratory curiosities)'에서 '살아있는 인간 세포 내의 유전적 돌연변이를 교정(correcting genetic mutations within living human cells)'하는 단계로의 전환을 강조합니다."
    },
    {
        id: "d-20260206-m-5",
        level: "Advanced",
        ...
        question: "지문이 강조하는 2026년 그린 수소 시장의 주요 트렌드는 무엇인가?",
        choices: [
            "전 세계적인 합의로 수소 수출이 일률적으로 금지되었다.",
            "수전해 비용 상승으로 중국을 포함한 전 세계 생산이 중단되었다.",
            "다른 지역이 재평가를 위해 주춤하는 동안 중국은 생산과 리더십을 확대하고 있다.",
            "서방 국가들이 그린 수소 기술 수출에서 중국을 추월했다."
        ],
        answer: 2,
        explanation: "텍스트는 중국의 '공격적인 확장(aggressive expansion)... 다른 지역과 극명하게 대조됨(contrasting sharply with other regions)'을 강조합니다."
    }
];
